...
res.json(users) // vai dar uma resposta (res) no formato json e essa resposta vai ser RESGATADA no array users 
...
res.json(req.body) //o post da a resposta do que ele está colocando no array, vai mostrar o json, a informação que foi requisitada
})
