...
class Filme {
  ...
  this.anoLancamento = anoLancamento;
    ...
    mostrando_informacoes(){
      console.log (`O filme ${this.titulo}, foi lançado em ${this.anoLancamento} e dirigido por ${this.diretor}.`);
    }
}

const demon_slayer_castelo_infinito = new Filme ('Demon Slayer: Kimetsu no Yaiba – Castelo Infinito', 2025, 'Haruo Sotozaki')
...
class Aluno{
  ...
  calculandoMedia(){
    ...
    console.log(`O aluno(a) ${this.nome} teve como média final ${media},sendo ${aprovacao}`);
  }
}
...
abastecerLitro() {
  ...
  console.log(`Foram abastecidos mais ${quantidadeAbastecida}L ao seu veículo, agora ele está com ${abastecer}L`);
}
...
dirigirKm() {
  ...
  console.log(`Depois de rodar por ${kmRodados}Km, seu veículo gastou ${gastoCombustivel}L, e ficou com ${quantidadeRestante}L`);
